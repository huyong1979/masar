...
class Ui_masar(object):
    def setupUi(self, masar):
        ...
        self.configEventSplitter.setMinimumSize(QtCore.QSize(600, 0))
        ...
        self.eventGridLayout.addWidget(self.fetchEventButton, 5, 0, 1, 2)
        ...
        self.eventGridLayout.addWidget(self.eventEndDateTime, 4, 1, 1, 2)
        ...
        self.eventGridLayout.addWidget(self.eventStartDateTime, 3, 1, 1, 2)
        ...
        self.eventGridLayout.addWidget(self.authorTextEdit, 1, 2, 1, 1)
        ...
        self.eventGridLayout.addWidget(self.timeRangeCheckBox, 2, 0, 1, 2)
        ...
        self.eventGridLayout.addWidget(self.eventFilterLineEdit, 0, 2, 1, 1)
        ...
        self.getGoldenButton = QtGui.QPushButton(self.layoutWidget1)
        self.getGoldenButton.setObjectName(_fromUtf8("getGoldenButton"))
        self.snapshotGridLayout.addWidget(self.getGoldenButton, 2, 1, 1, 1)
        ...
        self.snapshotGridLayout.addWidget(self.fetchSnapshotButton, 5, 0, 1, 2)
        ...
        self.snapshotGridLayout.addWidget(self.searchSnapshotButton, 3, 1, 1, 1)
        ...
        self.snapshotGridLayout.addWidget(self.snapshotIdLineEdit, 3, 0, 1, 1)
        self.setGoldenButton = QtGui.QPushButton(self.layoutWidget1)
        self.setGoldenButton.setObjectName(_fromUtf8("setGoldenButton"))
        self.snapshotGridLayout.addWidget(self.setGoldenButton, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pvFilterLineEdit, 2, 3, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout.addWidget(self.pvSearchButton, 2, 4, 1, 1, QtCore.Qt.AlignLeft)
        ...
        QtCore.QObject.connect(self.setGoldenButton, QtCore.SIGNAL(_fromUtf8("clicked()")), masar.setGoldenSnapshot)
        QtCore.QObject.connect(self.getGoldenButton, QtCore.SIGNAL(_fromUtf8("clicked()")), masar.fetchGoldenSnapshotAction)
    ...
    def retranslateUi(self, masar):
        masar.setWindowTitle(_translate("masar", "MASAR Viewer", None))
        self.systemCombox.setToolTip(_translate("masar", "sub-system to which configs/PV list belong", None))
        self.systemLabel.setText(_translate("masar", "System", None))
        self.configFilterLabel.setText(_translate("masar", "Config Filter", None))
        self.fetchConfigButton.setToolTip(_translate("masar", "<html><head/><body><p>get pre-defined configurations</p></body></html>", None))
        self.fetchConfigButton.setText(_translate("masar", "Select Config(s)", None))
        self.configTableWidget.setToolTip(_translate("masar", "<html><head/><body><p>ConfigTable: a list of pre-defined configs</p><p><span style=\" color:#00ff00;\">CLICK</span> on ONE row to fetch its list of snapshot(s)</p></body></html>", None))
        self.configTableWidget.setSortingEnabled(True)
        self.configFilterLineEdit.setToolTip(_translate("masar", "using expression like *LN*", None))
        self.configFilterLineEdit.setText(_translate("masar", "*", None))
        self.fetchEventButton.setToolTip(_translate("masar", "get a list of snapshot(s) or event(s)", None))
        self.fetchEventButton.setText(_translate("masar", "Select Snapshot(s)", None))
        self.ByWho.setText(_translate("masar", "Author", None))
        self.eventEndDateTime.setDisplayFormat(_translate("masar", "yyyy-MM-dd hh:mm:ss", None))
        self.eventStartDateTime.setDisplayFormat(_translate("masar", "yyyy-MM-dd hh:mm:ss", None))
        self.eventFilterLabel.setText(_translate("masar", "Snapshot Desc", None))
        self.eventEndLabel.setText(_translate("masar", "To:", None))
        self.authorTextEdit.setToolTip(_translate("masar", "using expression like *mei*", None))
        self.authorTextEdit.setText(_translate("masar", "*", None))
        self.timeRangeCheckBox.setText(_translate("masar", "Use time range:", None))
        self.eventFilterLineEdit.setToolTip(_translate("masar", "using expression like *BPM*", None))
        self.eventFilterLineEdit.setText(_translate("masar", "*", None))
        self.eventStartLabel.setText(_translate("masar", "From:", None))
        self.eventTableWidget.setToolTip(_translate("masar", "<html><head/><body><p>snapshotTable: a list of saved snapshot(s) for the selected config(s)</p><p><span style=\" color:#00ff00;\">Double CLICK</span> on one row to display <span style=\" color:#00ff00;\">ONE</span> snapshot data </p></body></html>", None))
        self.eventTableWidget.setSortingEnabled(True)
        self.getGoldenButton.setToolTip(_translate("masar", "<html><head/><body><p>get the Golden snapshot for the selected Config above</p></body></html>", None))
        self.getGoldenButton.setText(_translate("masar", "Dispaly Golden Snapshot", None))
        self.fetchSnapshotButton.setToolTip(_translate("masar", "get PVs data", None))
        self.fetchSnapshotButton.setText(_translate("masar", "Display Snapshot(s)", None))
        self.searchSnapshotButton.setToolTip(_translate("masar", "<html><head/><body><p>please enter a snapshot ID (one integer number, and only one) in the left box, then click this button</p></body></html>", None))
        self.searchSnapshotButton.setText(_translate("masar", "search a snapshot by its ID", None))
        self.snapshotIdLineEdit.setToolTip(_translate("masar", "<html><head/><body><p>Please enter one integer number and only one, then press Enter key or click the right-side button</p></body></html>", None))
        self.setGoldenButton.setToolTip(_translate("masar", "<html><head/><body><p>Set the selected snapshot above as golden snapshot</p></body></html>", None))
        self.setGoldenButton.setText(_translate("masar", "Set it As Golden", None))
        self.currentCommentText.setPlainText(_translate("masar", "\n"
...
"    [2] http://epics-pvdata.hg.sourceforge.net/hgweb/epics-pvdata/masarService/raw-file/tip/documentation/userManual.html", None))
        self.snapshotTabWidget.setTabText(self.snapshotTabWidget.indexOf(self.commentTab), _translate("masar", "Welcome to MASAR", None))
        self.snapshotTabWidget.setTabToolTip(self.snapshotTabWidget.indexOf(self.commentTab), _translate("masar", "How to use MASAR", None))
        self.compareSnapshotsButton.setText(_translate("masar", "Compare Snapshots...", None))
        self.pvFilterLineEdit.setToolTip(_translate("masar", "<html><head/><body><p>*BPM:[1-3]* to search any pv containing BPM:1, BPM:2, and BPM:3; press Enter key  or click the button \'PV Search\' when you are done with the search pattern</p></body></html>", None))
        self.getLiveMachineButton.setText(_translate("masar", "Compare Live Machine", None))
        self.saveMachineSnapshotButton.setText(_translate("masar", "Save Machine Snapshot ...", None))
        self.restoreMachineButton.setToolTip(_translate("masar", "one-step simple put", None))
        self.restoreMachineButton.setText(_translate("masar", "Restore Machine", None))
        self.saveDataFileButton.setText(_translate("masar", "Export Snapshot to File ...", None))
        self.pvSearchButton.setToolTip(_translate("masar", "<html><head/><body><p>search/filter pvs in the active snapshot Tab (the one you are watching. You can use Ctrl + F to search) </p></body></html>", None))
        self.pvSearchButton.setText(_translate("masar", "PV Search", None))
        self.rampingMachineButton.setToolTip(_translate("masar", "multiple-step grdual put", None))
        self.rampingMachineButton.setText(_translate("masar", "Ramping Machine...", None))
